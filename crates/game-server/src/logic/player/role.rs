...
impl RoleModel {
    ...
    pub async fn weapon_dress(
        &mut self,
        avatar_id: u32,
        weapon_uid: i32,
        is_signature_weapon: bool,
    ) -> Option<[u32; 2]> {
        ...
        let show_weapon_type = if is_signature_weapon {
            1
        } else {
            avatar.show_weapon_type
        };
        ...
        self.avatar_map.insert(
            ...
            avatar::ActiveModel {
                ...
                show_weapon_type: Set(show_weapon_type),
                ..avatar.into()
            }
    ...
    pub async fn toggle_weapon_show(&mut self, avatar_id: u32, show_weapon_type: i16) -> bool {
        let Some(mut avatar) = self.avatar_map.remove(&avatar_id) else {
            return false;
        };
