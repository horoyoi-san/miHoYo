...
public class GameData {
    ...
    private static Int2ObjectMap<MusicRhythmLevelExcel> musicRhythmLevelExcelMap = new Int2ObjectOpenHashMap();
    private static Int2ObjectMap<MusicRhythmGroupExcel> musicRhythmGroupExcelMap = new Int2ObjectOpenHashMap();
    private static Int2ObjectMap<MusicRhythmSongExcel> musicRhythmSongExcelMap = new Int2ObjectOpenHashMap();
    private static Int2ObjectMap<MusicRhythmTrackExcel> musicRhythmTrackExcelMap = new Int2ObjectOpenHashMap();
    private static Int2ObjectMap<MusicRhythmPhaseExcel> musicRhythmPhaseExcelMap = new Int2ObjectOpenHashMap();
    private static Int2ObjectMap<MusicRhythmSoundEffectExcel> musicRhythmSoundEffectExcelMap = new Int2ObjectOpenHashMap();
    ...
    public static Int2ObjectMap<MusicRhythmLevelExcel> getMusicRhythmLevelExcelMap() {
      return musicRhythmLevelExcelMap;
   }

   public static Int2ObjectMap<MusicRhythmGroupExcel> getMusicRhythmGroupExcelMap() {
      return musicRhythmGroupExcelMap;
   }

   public static Int2ObjectMap<MusicRhythmSongExcel> getMusicRhythmSongExcelMap() {
      return musicRhythmSongExcelMap;
   }

   public static Int2ObjectMap<MusicRhythmTrackExcel> getMusicRhythmTrackExcelMap() {
      return musicRhythmTrackExcelMap;
   }

   public static Int2ObjectMap<MusicRhythmPhaseExcel> getMusicRhythmPhaseExcelMap() {
      return musicRhythmPhaseExcelMap;
   }

   public static Int2ObjectMap<MusicRhythmSoundEffectExcel> getMusicRhythmSoundEffectExcelMap() {
      return musicRhythmSoundEffectExcelMap;
   }
