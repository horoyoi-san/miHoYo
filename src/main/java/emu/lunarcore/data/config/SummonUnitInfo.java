...
public class SummonUnitInfo {
    ...
    public List<SummonUnitCustomTrigger> getCustomTriggers() {
        if (TriggerConfig == null) {
            // 处理 TriggerConfig 为空的情况，例如初始化或抛出异常
            TriggerConfig = new SummonUnitTriggers();
            TriggerConfig.setCustomTriggers(new ArrayList<>()); // 确保 CustomTriggers 不为 null
        }
    ...
    public static class SummonUnitTriggers {
        ...
        public void setCustomTriggers(List<SummonUnitCustomTrigger> customTriggers) {
