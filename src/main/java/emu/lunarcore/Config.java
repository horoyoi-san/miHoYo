...
public class Config {
    ...
    public static class GameServerConfig extends ServerConfig {
        public String id = "Horoyoi-sanSR_rail_test";
        public String name = "Horoyoi-sanSR-LC";
        public String description = "A Horoyoi-sanSR server";
    ...
    public static class ServerProfile {
        public String name = "BaiJia";
        public String signature = "Welcome to Horoyoi-sanSR-LC, enter commands here!";
        public int level = 1;
    ...
    public static class WelcomeMail {
        ...
        public WelcomeMail() {
            this.title = "Welcome to a Horoyoi-sanSR-LC.";
            this.sender = "BaiJia";
            this.content = "Welcome to Horoyoi-sanSR-LC! Please take these items as a starter gift. For a list of commands, type /help in the server chat window. ";
    ...
    public static class AnnounceData {
        ...
        public String bannerText = "Welcome to use Horoyoi-sanSR-LC,Love from Whitejia!";
        public String adminBannerText = "Welcome to use Horoyoi-sanSR-LC,Love from Whitejia!";
