...
public class LunarCore {
    ...
    private static final File configFile = new File("./ASL/config.json");
    private static final File hotfixFile = new File("./ASL/hotfix.json");
    ...
    public static void main(String[] args) {
        // Start Server
        LunarCore.getLogger().info("Starting Horoyoi-sanSR " + getJarVersion());
