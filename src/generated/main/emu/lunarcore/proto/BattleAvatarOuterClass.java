...
public final class BattleAvatarOuterClass {
  ...
  public static final class BattleAvatar extends ProtoMessage<BattleAvatar> implements Cloneable {
    ...
    /**
     * <code>optional uint32 GMOBAOCEFCE = 17;</code>
     */
    private int gMOBAOCEFCE;
    ...
    /**
     * <code>optional uint32 GMOBAOCEFCE = 17;</code>
     * @return whether the gMOBAOCEFCE field is set
     */
    public boolean hasGMOBAOCEFCE() {
     ...
     * @return this
     */
    public BattleAvatar clearGMOBAOCEFCE() {
    ...
    /**
     * <code>optional uint32 GMOBAOCEFCE = 17;</code>
     * @return the gMOBAOCEFCE
     */
    public int getGMOBAOCEFCE() {
      return gMOBAOCEFCE;
    }

    /**
     * <code>optional uint32 GMOBAOCEFCE = 17;</code>
     * @param value the gMOBAOCEFCE to set
     * @return this
     */
    public BattleAvatar setGMOBAOCEFCE(final int value) {
      bitField0_ |= 0x00000100;
      gMOBAOCEFCE = value;
      return this;
    }
    ...
    public BattleAvatar mergeFrom(final BattleAvatar other) {
      ...
      if (other.hasGMOBAOCEFCE()) {
        setGMOBAOCEFCE(other.gMOBAOCEFCE);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasGMOBAOCEFCE() || gMOBAOCEFCE == other.gMOBAOCEFCE)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000100) != 0) {
        ...
        output.writeUInt32NoTag(gMOBAOCEFCE);
      }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000100) != 0) {
        size += 2 + ProtoSink.computeUInt32SizeNoTag(gMOBAOCEFCE);
      }
      if ((bitField0_ & 0x00000200) != 0) {
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000100) != 0) {
        output.writeUInt32(FieldNames.gMOBAOCEFCE, gMOBAOCEFCE);
      }
      if ((bitField0_ & 0x00000200) != 0) {
    ...
    public BattleAvatar mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case 1204085951: {
            if (input.isAtField(FieldNames.gMOBAOCEFCE)) {
              if (!input.trySkipNullValue()) {
                gMOBAOCEFCE = input.readUInt32();
                bitField0_ |= 0x00000100;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName gMOBAOCEFCE = FieldName.forField("GMOBAOCEFCE");
