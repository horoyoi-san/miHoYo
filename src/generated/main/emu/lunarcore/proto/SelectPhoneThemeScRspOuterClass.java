...
public final class SelectPhoneThemeScRspOuterClass {
  ...
  public static final class SelectPhoneThemeScRsp extends ProtoMessage<SelectPhoneThemeScRsp> implements Cloneable {
    ...
    /**
     * <code>optional uint32 ACHOPOJLCCE = 9;</code>
     */
    private int aCHOPOJLCCE;

    /**
     * <code>optional uint32 cur_phone_theme = 15;</code>
     */
    ...
    /**
     * <code>optional uint32 ACHOPOJLCCE = 9;</code>
     * @return whether the aCHOPOJLCCE field is set
     */
    public boolean hasACHOPOJLCCE() {
     ...
     * @return this
     */
    public SelectPhoneThemeScRsp clearACHOPOJLCCE() {
    ...
    /**
     * <code>optional uint32 ACHOPOJLCCE = 9;</code>
     * @return the aCHOPOJLCCE
     */
    public int getACHOPOJLCCE() {
      return aCHOPOJLCCE;
    }

    /**
     * <code>optional uint32 ACHOPOJLCCE = 9;</code>
     * @param value the aCHOPOJLCCE to set
     * @return this
     */
    public SelectPhoneThemeScRsp setACHOPOJLCCE(final int value) {
      bitField0_ |= 0x00000002;
      aCHOPOJLCCE = value;
      return this;
    }
    ...
    public SelectPhoneThemeScRsp mergeFrom(final SelectPhoneThemeScRsp other) {
      ...
      if (other.hasACHOPOJLCCE()) {
        setACHOPOJLCCE(other.aCHOPOJLCCE);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasACHOPOJLCCE() || aCHOPOJLCCE == other.aCHOPOJLCCE)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        ...
        output.writeUInt32NoTag(aCHOPOJLCCE);
      }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        size += 1 + ProtoSink.computeUInt32SizeNoTag(aCHOPOJLCCE);
      }
      if ((bitField0_ & 0x00000004) != 0) {
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        output.writeUInt32(FieldNames.aCHOPOJLCCE, aCHOPOJLCCE);
      }
      if ((bitField0_ & 0x00000004) != 0) {
    ...
    public SelectPhoneThemeScRsp mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case -1845639173: {
            if (input.isAtField(FieldNames.aCHOPOJLCCE)) {
              if (!input.trySkipNullValue()) {
                aCHOPOJLCCE = input.readUInt32();
                bitField0_ |= 0x00000002;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName aCHOPOJLCCE = FieldName.forField("ACHOPOJLCCE");
