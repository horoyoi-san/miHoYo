...
public final class SceneEntityRefreshInfoOuterClass {
  ...
  public static final class SceneEntityRefreshInfo extends ProtoMessage<SceneEntityRefreshInfo> implements Cloneable {
     ...
     * </pre>
     *
     * <code>optional uint32 del_entity = 6;</code>
     */
    private int delEntity;

    /**
     * <code>optional uint32 MELFHAOJLEL = 13;</code>
     */
    private int mELFHAOJLEL;

    /**
     * <code>optional .SceneEntityInfo add_entity = 15;</code>
     */
    ...
    public boolean hasMNCFCHACEGC() {
      return (((bitField0_ & 0x00000007)) != 0);
    }

    public SceneEntityRefreshInfo clearMNCFCHACEGC() {
      if (hasMNCFCHACEGC()) {
        clearDelEntity();
        clearMELFHAOJLEL();
        clearAddEntity();
    ...
    private void clearMNCFCHACEGCOtherDelEntity() {
    ...
    private void clearMNCFCHACEGCOtherMELFHAOJLEL() {
    ...
    private void clearMNCFCHACEGCOtherAddEntity() {
    ...
    public SceneEntityRefreshInfo setDelEntity(final int value) {
      clearMNCFCHACEGCOtherDelEntity();
      bitField0_ |= 0x00000001;
      delEntity = value;
      return this;
    }
    ...
    /**
     * <code>optional uint32 MELFHAOJLEL = 13;</code>
     * @return whether the mELFHAOJLEL field is set
     */
    public boolean hasMELFHAOJLEL() {
     ...
     * @return this
     */
    public SceneEntityRefreshInfo clearMELFHAOJLEL() {
    ...
    /**
     * <code>optional uint32 MELFHAOJLEL = 13;</code>
     * @return the mELFHAOJLEL
     */
    public int getMELFHAOJLEL() {
      return mELFHAOJLEL;
    }

    /**
     * <code>optional uint32 MELFHAOJLEL = 13;</code>
     * @param value the mELFHAOJLEL to set
     * @return this
     */
    public SceneEntityRefreshInfo setMELFHAOJLEL(final int value) {
      clearMNCFCHACEGCOtherMELFHAOJLEL();
      bitField0_ |= 0x00000002;
      mELFHAOJLEL = value;
      return this;
    }
    ...
    public SceneEntityInfoOuterClass.SceneEntityInfo getMutableAddEntity() {
      clearMNCFCHACEGCOtherAddEntity();
      bitField0_ |= 0x00000004;
      return addEntity;
    }
    ...
    public SceneEntityRefreshInfo mergeFrom(final SceneEntityRefreshInfo other) {
      ...
      if (other.hasMELFHAOJLEL()) {
        setMELFHAOJLEL(other.mELFHAOJLEL);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasMELFHAOJLEL() || mELFHAOJLEL == other.mELFHAOJLEL)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        ...
        output.writeUInt32NoTag(mELFHAOJLEL);
      }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        size += 1 + ProtoSink.computeUInt32SizeNoTag(mELFHAOJLEL);
      }
      if ((bitField0_ & 0x00000004) != 0) {
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        output.writeUInt32(FieldNames.mELFHAOJLEL, mELFHAOJLEL);
      }
      if ((bitField0_ & 0x00000004) != 0) {
    ...
    public SceneEntityRefreshInfo mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case 1621110669: {
            if (input.isAtField(FieldNames.mELFHAOJLEL)) {
              if (!input.trySkipNullValue()) {
                clearMNCFCHACEGCOtherMELFHAOJLEL();
                mELFHAOJLEL = input.readUInt32();
                bitField0_ |= 0x00000002;
    ...
    static class FieldNames {
      ...
      static final FieldName mELFHAOJLEL = FieldName.forField("MELFHAOJLEL");
