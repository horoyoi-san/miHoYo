...
public final class SelectChatBubbleScRspOuterClass {
  ...
  public static final class SelectChatBubbleScRsp extends ProtoMessage<SelectChatBubbleScRsp> implements Cloneable {
    ...
    /**
     * <code>optional uint32 PMDCBFOPCHB = 4;</code>
     */
    private int pMDCBFOPCHB;
    ...
    /**
     * <code>optional uint32 PMDCBFOPCHB = 4;</code>
     * @return whether the pMDCBFOPCHB field is set
     */
    public boolean hasPMDCBFOPCHB() {
     ...
     * @return this
     */
    public SelectChatBubbleScRsp clearPMDCBFOPCHB() {
    ...
    /**
     * <code>optional uint32 PMDCBFOPCHB = 4;</code>
     * @return the pMDCBFOPCHB
     */
    public int getPMDCBFOPCHB() {
      return pMDCBFOPCHB;
    }

    /**
     * <code>optional uint32 PMDCBFOPCHB = 4;</code>
     * @param value the pMDCBFOPCHB to set
     * @return this
     */
    public SelectChatBubbleScRsp setPMDCBFOPCHB(final int value) {
      bitField0_ |= 0x00000002;
      pMDCBFOPCHB = value;
      return this;
    }
    ...
    public SelectChatBubbleScRsp mergeFrom(final SelectChatBubbleScRsp other) {
      ...
      if (other.hasPMDCBFOPCHB()) {
        setPMDCBFOPCHB(other.pMDCBFOPCHB);
      }
      if (other.hasRetcode()) {
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasPMDCBFOPCHB() || pMDCBFOPCHB == other.pMDCBFOPCHB)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        ...
        output.writeUInt32NoTag(pMDCBFOPCHB);
      }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        size += 1 + ProtoSink.computeUInt32SizeNoTag(pMDCBFOPCHB);
      }
      if ((bitField0_ & 0x00000004) != 0) {
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        output.writeUInt32(FieldNames.pMDCBFOPCHB, pMDCBFOPCHB);
      }
      if ((bitField0_ & 0x00000004) != 0) {
    ...
    public SelectChatBubbleScRsp mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case -1292352900: {
            if (input.isAtField(FieldNames.pMDCBFOPCHB)) {
              if (!input.trySkipNullValue()) {
                pMDCBFOPCHB = input.readUInt32();
                bitField0_ |= 0x00000002;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName pMDCBFOPCHB = FieldName.forField("PMDCBFOPCHB");
