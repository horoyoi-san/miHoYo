...
public final class GetAvatarDataScRspOuterClass {
  ...
  public static final class GetAvatarDataScRsp extends ProtoMessage<GetAvatarDataScRsp> implements Cloneable {
    ...
    /**
     * <code>optional uint32 JPNLPOPMKEJ = 8;</code>
     */
    private int jPNLPOPMKEJ;

    /**
     * <code>optional bool is_get_all = 13;</code>
     */
    private boolean isGetAll;

    /**
     * <code>repeated uint32 skin = 9;</code>
     */
    private final RepeatedInt skin = RepeatedInt.newEmptyInstance();

    /**
     * <code>repeated .Avatar avatar_list = 2;</code>
     */
    ...
    /**
     * <code>optional uint32 JPNLPOPMKEJ = 8;</code>
     * @return whether the jPNLPOPMKEJ field is set
     */
    public boolean hasJPNLPOPMKEJ() {
     ...
     * @return this
     */
    public GetAvatarDataScRsp clearJPNLPOPMKEJ() {
    ...
    /**
     * <code>optional uint32 JPNLPOPMKEJ = 8;</code>
     * @return the jPNLPOPMKEJ
     */
    public int getJPNLPOPMKEJ() {
      return jPNLPOPMKEJ;
    }

    /**
     * <code>optional uint32 JPNLPOPMKEJ = 8;</code>
     * @param value the jPNLPOPMKEJ to set
     * @return this
     */
    public GetAvatarDataScRsp setJPNLPOPMKEJ(final int value) {
      bitField0_ |= 0x00000002;
      jPNLPOPMKEJ = value;
      return this;
    }
     ...
     * @return this
     */
    public GetAvatarDataScRsp clearSkin() {
     ...
     *
     * Use {@link #getMutableSkin()} if you want to modify it.
     *
     * @return internal storage object for reading
     */
    public RepeatedInt getSkin() {
      return skin;
    }
     ...
     */
    public RepeatedInt getMutableSkin() {
      bitField0_ |= 0x00000008;
      return skin;
    }
    ...
    /**
     * <code>repeated uint32 skin = 9;</code>
     * @param value the skin to add
     * @return this
     */
    public GetAvatarDataScRsp addSkin(final int value) {
      bitField0_ |= 0x00000008;
      skin.add(value);
      return this;
    }
    ...
    /**
     * <code>repeated uint32 skin = 9;</code>
     * @param values the skin to add
     * @return this
     */
    public GetAvatarDataScRsp addAllSkin(final int... values) {
      bitField0_ |= 0x00000008;
      skin.addAll(values);
      return this;
    }
    ...
    public GetAvatarDataScRsp mergeFrom(final GetAvatarDataScRsp other) {
      ...
      if (other.hasJPNLPOPMKEJ()) {
        setJPNLPOPMKEJ(other.jPNLPOPMKEJ);
      }
      if (other.hasIsGetAll()) {
        setIsGetAll(other.isGetAll);
      }
      if (other.hasSkin()) {
        getMutableSkin().addAll(other.skin);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasJPNLPOPMKEJ() || jPNLPOPMKEJ == other.jPNLPOPMKEJ)
        && (!hasIsGetAll() || isGetAll == other.isGetAll)
        && (!hasSkin() || skin.equals(other.skin))
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        ...
        output.writeUInt32NoTag(jPNLPOPMKEJ);
      }
      ...
      if ((bitField0_ & 0x00000008) != 0) {
        for (int i = 0; i < skin.length(); i++) {
          ...
          output.writeUInt32NoTag(skin.array()[i]);
        }
      }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        size += 1 + ProtoSink.computeUInt32SizeNoTag(jPNLPOPMKEJ);
      }
      if ((bitField0_ & 0x00000004) != 0) {
        size += 2;
      }
      if ((bitField0_ & 0x00000008) != 0) {
        size += (1 * skin.length()) + ProtoSink.computeRepeatedUInt32SizeNoTag(skin);
      }
      if ((bitField0_ & 0x00000010) != 0) {
    ...
    public GetAvatarDataScRsp mergeFrom(final ProtoSource input) throws IOException {
      ...
      while (true) {
        switch (tag) {
          ...
          case 74: {
            // skin [packed=true]
            input.readPackedUInt32(skin, tag);
            bitField0_ |= 0x00000008;
            tag = input.readTag();
            if (tag != 18) {
              break;
          ...
          case 72: {
            // skin [packed=false]
            tag = input.readRepeatedUInt32(skin, tag);
            bitField0_ |= 0x00000008;
            break;
          }
        }
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        output.writeUInt32(FieldNames.jPNLPOPMKEJ, jPNLPOPMKEJ);
      }
      if ((bitField0_ & 0x00000004) != 0) {
        output.writeBool(FieldNames.isGetAll, isGetAll);
      }
      if ((bitField0_ & 0x00000008) != 0) {
        output.writeRepeatedUInt32(FieldNames.skin, skin);
      }
      if ((bitField0_ & 0x00000010) != 0) {
    ...
    public GetAvatarDataScRsp mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case 2014249584: {
            if (input.isAtField(FieldNames.jPNLPOPMKEJ)) {
              if (!input.trySkipNullValue()) {
                jPNLPOPMKEJ = input.readUInt32();
                bitField0_ |= 0x00000002;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName jPNLPOPMKEJ = FieldName.forField("JPNLPOPMKEJ");
