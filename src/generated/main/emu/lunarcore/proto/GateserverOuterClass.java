...
public final class GateserverOuterClass {
  ...
  public static final class Gateserver extends ProtoMessage<Gateserver> implements Cloneable {
    ...
    /**
     * <code>optional bool unk1 = 7;</code>
     */
    private boolean unk1;

    /**
     * <code>optional bool unk2 = 11;</code>
     */
    private boolean unk2;

    /**
     * <code>optional bool unk3 = 236;</code>
     */
    private boolean unk3;

    /**
     * <code>optional bool unk4 = 435;</code>
     */
    private boolean unk4;

    /**
     * <code>optional bool unk5 = 465;</code>
     */
    private boolean unk5;

    /**
     * <code>optional bool unk6 = 915;</code>
     */
    private boolean unk6;

    /**
     * <code>optional bool unk7 = 997;</code>
     */
    private boolean unk7;

    /**
     * <code>optional bool unk8 = 1149;</code>
     */
    private boolean unk8;

    /**
     * <code>optional bool unk9 = 1206;</code>
     */
    private boolean unk9;

    /**
     * <code>optional bool unk10 = 1829;</code>
     */
    private boolean unk10;

    /**
     * <code>optional bool unk11 = 2023;</code>
     */
    private boolean unk11;

    /**
     * <code>optional string lua_url = 1;</code>
     */
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000008) != 0) {
        output.writeRawLittleEndian16((short) 3808);
        output.writeBoolNoTag(unk3);
      }
      if ((bitField0_ & 0x00000010) != 0) {
        output.writeRawLittleEndian16((short) 7064);
        output.writeBoolNoTag(unk4);
      }
      if ((bitField0_ & 0x00000020) != 0) {
        output.writeRawLittleEndian16((short) 7560);
        output.writeBoolNoTag(unk5);
      }
      if ((bitField0_ & 0x00000040) != 0) {
        output.writeRawLittleEndian16((short) 14744);
        output.writeBoolNoTag(unk6);
      }
      if ((bitField0_ & 0x00000080) != 0) {
        output.writeRawLittleEndian16((short) 16040);
        output.writeBoolNoTag(unk7);
      }
      if ((bitField0_ & 0x00000100) != 0) {
        output.writeRawLittleEndian16((short) 18408);
        output.writeBoolNoTag(unk8);
      }
      if ((bitField0_ & 0x00000200) != 0) {
        output.writeRawLittleEndian16((short) 19376);
        output.writeBoolNoTag(unk9);
      }
      if ((bitField0_ & 0x00000400) != 0) {
        output.writeRawLittleEndian16((short) 29352);
        output.writeBoolNoTag(unk10);
      }
      if ((bitField0_ & 0x00000800) != 0) {
        output.writeRawLittleEndian16((short) 32440);
      ...
      if ((bitField0_ & 0x00020000) != 0) {
        output.writeRawLittleEndian16((short) 15746);
        output.writeStringNoTag(msg);
      }
      if ((bitField0_ & 0x00040000) != 0) {
        output.writeRawLittleEndian16((short) 30154);
