...
public final class SimpleInfoOuterClass {
  ...
  public static final class SimpleInfo extends ProtoMessage<SimpleInfo> implements Cloneable {
    ...
    /**
     * <code>optional int64 last_active_time = 4;</code>
     */
    ...
    /**
     * <code>optional uint32 head_icon = 15;</code>
     */
    ...
    /**
     * <code>optional .PlatformType platform_type = 8;</code>
     */
    ...
    /**
     * <code>optional string GMALCPNOHBF = 1;</code>
     */
    private final Utf8String gMALCPNOHBF = Utf8String.newEmptyInstance();
    ...
    /**
     * <code>optional string AKCEJFCFBAN = 6;</code>
     */
    private final Utf8String aKCEJFCFBAN = Utf8String.newEmptyInstance();
    ...
    /**
     * <code>repeated .AssistSimpleInfo assist_simple_info = 10;</code>
     */
    ...
    /**
     * <code>optional string GMALCPNOHBF = 1;</code>
     * @return whether the gMALCPNOHBF field is set
     */
    public boolean hasGMALCPNOHBF() {
     ...
     * @return this
     */
    public SimpleInfo clearGMALCPNOHBF() {
    ...
    /**
     * <code>optional string GMALCPNOHBF = 1;</code>
     * @return the gMALCPNOHBF
     */
    public String getGMALCPNOHBF() {
      return gMALCPNOHBF.getString();
    }

    /**
     * <code>optional string GMALCPNOHBF = 1;</code>
     * @return internal {@code Utf8String} representation of gMALCPNOHBF for reading
     */
    public Utf8String getGMALCPNOHBFBytes() {
      return this.gMALCPNOHBF;
    }

    /**
     * <code>optional string GMALCPNOHBF = 1;</code>
     * @return internal {@code Utf8String} representation of gMALCPNOHBF for modifications
     */
    public Utf8String getMutableGMALCPNOHBFBytes() {
      bitField0_ |= 0x00000100;
      return this.gMALCPNOHBF;
    }
    ...
    /**
     * <code>optional string GMALCPNOHBF = 1;</code>
     * @param value the gMALCPNOHBF to set
     * @return this
     */
    public SimpleInfo setGMALCPNOHBF(final CharSequence value) {
      bitField0_ |= 0x00000100;
      gMALCPNOHBF.copyFrom(value);
      return this;
    }
     ...
     * @return this
     */
    public SimpleInfo setGMALCPNOHBF(final Utf8String value) {
      bitField0_ |= 0x00000100;
      gMALCPNOHBF.copyFrom(value);
      return this;
    }
    ...
    /**
     * <code>optional string AKCEJFCFBAN = 6;</code>
     * @return whether the aKCEJFCFBAN field is set
     */
    public boolean hasAKCEJFCFBAN() {
     ...
     * @return this
     */
    public SimpleInfo clearAKCEJFCFBAN() {
    ...
    /**
     * <code>optional string AKCEJFCFBAN = 6;</code>
     * @return the aKCEJFCFBAN
     */
    public String getAKCEJFCFBAN() {
      return aKCEJFCFBAN.getString();
    }

    /**
     * <code>optional string AKCEJFCFBAN = 6;</code>
     * @return internal {@code Utf8String} representation of aKCEJFCFBAN for reading
     */
    public Utf8String getAKCEJFCFBANBytes() {
      return this.aKCEJFCFBAN;
    }

    /**
     * <code>optional string AKCEJFCFBAN = 6;</code>
     * @return internal {@code Utf8String} representation of aKCEJFCFBAN for modifications
     */
    public Utf8String getMutableAKCEJFCFBANBytes() {
      bitField0_ |= 0x00000400;
      return this.aKCEJFCFBAN;
    }
    ...
    /**
     * <code>optional string AKCEJFCFBAN = 6;</code>
     * @param value the aKCEJFCFBAN to set
     * @return this
     */
    public SimpleInfo setAKCEJFCFBAN(final CharSequence value) {
      bitField0_ |= 0x00000400;
      aKCEJFCFBAN.copyFrom(value);
      return this;
    }
     ...
     * @return this
     */
    public SimpleInfo setAKCEJFCFBAN(final Utf8String value) {
      bitField0_ |= 0x00000400;
      aKCEJFCFBAN.copyFrom(value);
      return this;
    }
    ...
    public SimpleInfo copyFrom(final SimpleInfo other) {
      ...
      if ((bitField0_ | other.bitField0_) != 0) {
        ...
        gMALCPNOHBF.copyFrom(other.gMALCPNOHBF);
        signature.copyFrom(other.signature);
        aKCEJFCFBAN.copyFrom(other.aKCEJFCFBAN);
    ...
    public SimpleInfo mergeFrom(final SimpleInfo other) {
      ...
      if (other.hasGMALCPNOHBF()) {
        getMutableGMALCPNOHBFBytes().copyFrom(other.gMALCPNOHBF);
      }
      if (other.hasSignature()) {
        getMutableSignatureBytes().copyFrom(other.signature);
      }
      if (other.hasAKCEJFCFBAN()) {
        getMutableAKCEJFCFBANBytes().copyFrom(other.aKCEJFCFBAN);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasGMALCPNOHBF() || gMALCPNOHBF.equals(other.gMALCPNOHBF))
        && (!hasSignature() || signature.equals(other.signature))
        && (!hasAKCEJFCFBAN() || aKCEJFCFBAN.equals(other.aKCEJFCFBAN))
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000100) != 0) {
        ...
        output.writeStringNoTag(gMALCPNOHBF);
      }
      ...
      if ((bitField0_ & 0x00000400) != 0) {
        ...
        output.writeStringNoTag(aKCEJFCFBAN);
      }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000100) != 0) {
        size += 1 + ProtoSink.computeStringSizeNoTag(gMALCPNOHBF);
      }
      if ((bitField0_ & 0x00000200) != 0) {
        size += 1 + ProtoSink.computeStringSizeNoTag(signature);
      }
      if ((bitField0_ & 0x00000400) != 0) {
        size += 1 + ProtoSink.computeStringSizeNoTag(aKCEJFCFBAN);
      }
      if ((bitField0_ & 0x00000800) != 0) {
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000100) != 0) {
        output.writeString(FieldNames.gMALCPNOHBF, gMALCPNOHBF);
      }
      if ((bitField0_ & 0x00000200) != 0) {
        output.writeString(FieldNames.signature, signature);
      }
      if ((bitField0_ & 0x00000400) != 0) {
        output.writeString(FieldNames.aKCEJFCFBAN, aKCEJFCFBAN);
      }
      if ((bitField0_ & 0x00000800) != 0) {
    ...
    public SimpleInfo mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case -1493993427: {
            if (input.isAtField(FieldNames.gMALCPNOHBF)) {
              if (!input.trySkipNullValue()) {
                input.readString(gMALCPNOHBF);
                bitField0_ |= 0x00000100;
              }
          ...
          case -218037916: {
            if (input.isAtField(FieldNames.aKCEJFCFBAN)) {
              if (!input.trySkipNullValue()) {
                input.readString(aKCEJFCFBAN);
                bitField0_ |= 0x00000400;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName gMALCPNOHBF = FieldName.forField("GMALCPNOHBF");

      static final FieldName signature = FieldName.forField("signature");

      static final FieldName aKCEJFCFBAN = FieldName.forField("AKCEJFCFBAN");
