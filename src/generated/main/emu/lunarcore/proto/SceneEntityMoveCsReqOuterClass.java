...
public final class SceneEntityMoveCsReqOuterClass {
  ...
  public static final class SceneEntityMoveCsReq extends ProtoMessage<SceneEntityMoveCsReq> implements Cloneable {
    ...
    /**
     * <code>optional uint64 PEMLEJJBAJE = 13;</code>
     */
    private long pEMLEJJBAJE;
    ...
    /**
     * <code>optional uint64 PEMLEJJBAJE = 13;</code>
     * @return whether the pEMLEJJBAJE field is set
     */
    public boolean hasPEMLEJJBAJE() {
     ...
     * @return this
     */
    public SceneEntityMoveCsReq clearPEMLEJJBAJE() {
    ...
    /**
     * <code>optional uint64 PEMLEJJBAJE = 13;</code>
     * @return the pEMLEJJBAJE
     */
    public long getPEMLEJJBAJE() {
      return pEMLEJJBAJE;
    }

    /**
     * <code>optional uint64 PEMLEJJBAJE = 13;</code>
     * @param value the pEMLEJJBAJE to set
     * @return this
     */
    public SceneEntityMoveCsReq setPEMLEJJBAJE(final long value) {
      bitField0_ |= 0x00000001;
      pEMLEJJBAJE = value;
      return this;
    }
    ...
    public SceneEntityMoveCsReq mergeFrom(final SceneEntityMoveCsReq other) {
      ...
      cachedSize = -1;
      if (other.hasPEMLEJJBAJE()) {
        setPEMLEJJBAJE(other.pEMLEJJBAJE);
      }
      if (other.hasEntryId()) {
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        && (!hasPEMLEJJBAJE() || pEMLEJJBAJE == other.pEMLEJJBAJE)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      if ((bitField0_ & 0x00000001) != 0) {
        ...
        output.writeUInt64NoTag(pEMLEJJBAJE);
      }
    ...
    protected int computeSerializedSize() {
      int size = 0;
      if ((bitField0_ & 0x00000001) != 0) {
        size += 1 + ProtoSink.computeUInt64SizeNoTag(pEMLEJJBAJE);
      }
      if ((bitField0_ & 0x00000002) != 0) {
    ...
    public void writeTo(final JsonSink output) throws IOException {
      output.beginObject();
      if ((bitField0_ & 0x00000001) != 0) {
        output.writeUInt64(FieldNames.pEMLEJJBAJE, pEMLEJJBAJE);
      }
      if ((bitField0_ & 0x00000002) != 0) {
    ...
    public SceneEntityMoveCsReq mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          case -1825018197: {
            if (input.isAtField(FieldNames.pEMLEJJBAJE)) {
    ...
    static class FieldNames {
      static final FieldName pEMLEJJBAJE = FieldName.forField("PEMLEJJBAJE");
