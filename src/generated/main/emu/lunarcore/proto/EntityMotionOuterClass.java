...
public final class EntityMotionOuterClass {
  ...
  public static final class EntityMotion extends ProtoMessage<EntityMotion> implements Cloneable {
    ...
    /**
     * <code>optional bool NFOPIKDKPGG = 7;</code>
     */
    private boolean nFOPIKDKPGG;

    /**
     * <code>optional .MotionInfo motion = 9;</code>
     */
    ...
    /**
     * <code>optional bool NFOPIKDKPGG = 7;</code>
     * @return whether the nFOPIKDKPGG field is set
     */
    public boolean hasNFOPIKDKPGG() {
     ...
     * @return this
     */
    public EntityMotion clearNFOPIKDKPGG() {
    ...
    /**
     * <code>optional bool NFOPIKDKPGG = 7;</code>
     * @return the nFOPIKDKPGG
     */
    public boolean getNFOPIKDKPGG() {
      return nFOPIKDKPGG;
    }

    /**
     * <code>optional bool NFOPIKDKPGG = 7;</code>
     * @param value the nFOPIKDKPGG to set
     * @return this
     */
    public EntityMotion setNFOPIKDKPGG(final boolean value) {
      bitField0_ |= 0x00000004;
      nFOPIKDKPGG = value;
      return this;
    }
    ...
    public EntityMotion mergeFrom(final EntityMotion other) {
      ...
      if (other.hasNFOPIKDKPGG()) {
        setNFOPIKDKPGG(other.nFOPIKDKPGG);
      }
      if (other.hasMotion()) {
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasNFOPIKDKPGG() || nFOPIKDKPGG == other.nFOPIKDKPGG)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000004) != 0) {
        ...
        output.writeBoolNoTag(nFOPIKDKPGG);
      }
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000004) != 0) {
        output.writeBool(FieldNames.nFOPIKDKPGG, nFOPIKDKPGG);
      }
      if ((bitField0_ & 0x00000008) != 0) {
    ...
    public EntityMotion mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case -87845970: {
            if (input.isAtField(FieldNames.nFOPIKDKPGG)) {
              if (!input.trySkipNullValue()) {
                nFOPIKDKPGG = input.readBool();
                bitField0_ |= 0x00000004;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName nFOPIKDKPGG = FieldName.forField("NFOPIKDKPGG");
