...
public final class BuffInfoOuterClass {
  ...
  public static final class BuffInfo extends ProtoMessage<BuffInfo> implements Cloneable {
    ...
    /**
     * <code>optional float life_time = 7;</code>
     */
    ...
    /**
     * <code>optional uint32 buff_summon_entity_id = 12;</code>
     */
    private int buffSummonEntityId;

    /**
     * <code>repeated .BuffInfo.DynamicValuesEntry dynamic_values = 14;</code>
     */
    ...
    /**
     * <code>optional uint32 buff_summon_entity_id = 12;</code>
     * @return whether the buffSummonEntityId field is set
     */
    public boolean hasBuffSummonEntityId() {
     ...
     * @return this
     */
    public BuffInfo clearBuffSummonEntityId() {
      bitField0_ &= ~0x00000040;
      buffSummonEntityId = 0;
      return this;
    }

    /**
     * <code>optional uint32 buff_summon_entity_id = 12;</code>
     * @return the buffSummonEntityId
     */
    public int getBuffSummonEntityId() {
      return buffSummonEntityId;
    }

    /**
     * <code>optional uint32 buff_summon_entity_id = 12;</code>
     * @param value the buffSummonEntityId to set
     * @return this
     */
    public BuffInfo setBuffSummonEntityId(final int value) {
      bitField0_ |= 0x00000040;
      buffSummonEntityId = value;
      return this;
    }
    ...
    public BuffInfo mergeFrom(final BuffInfo other) {
      ...
      if (other.hasBuffSummonEntityId()) {
        setBuffSummonEntityId(other.buffSummonEntityId);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasBuffSummonEntityId() || buffSummonEntityId == other.buffSummonEntityId)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000040) != 0) {
        ...
        output.writeUInt32NoTag(buffSummonEntityId);
      }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000040) != 0) {
        size += 1 + ProtoSink.computeUInt32SizeNoTag(buffSummonEntityId);
      }
      if ((bitField0_ & 0x00000080) != 0) {
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000040) != 0) {
        output.writeUInt32(FieldNames.buffSummonEntityId, buffSummonEntityId);
      }
      if ((bitField0_ & 0x00000080) != 0) {
    ...
    public BuffInfo mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case -610122862:
          case -855599227: {
            if (input.isAtField(FieldNames.buffSummonEntityId)) {
              if (!input.trySkipNullValue()) {
                buffSummonEntityId = input.readUInt32();
                bitField0_ |= 0x00000040;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName buffSummonEntityId = FieldName.forField("buffSummonEntityId", "buff_summon_entity_id");
